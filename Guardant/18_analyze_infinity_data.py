...
def main():
    ...
    with open('infinity_analysis_summary.txt', 'w') as f:
        f.write(infinity_summary_buffer.getvalue())
    
    with open('infinity_detailed_mutation_analysis.txt', 'w') as f:
        f.write(infinity_detail_buffer.getvalue())
    
    print("Analysis complete. Results saved to infinity_analysis_summary.txt and infinity_detailed_mutation_analysis.txt")
