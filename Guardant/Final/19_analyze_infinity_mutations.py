...
summary_df.to_csv('infinity_mutation_summary_corrected.csv', index=False)
print("Summary saved to: infinity_mutation_summary_corrected.csv")
...
# Save to file
with open('infinity_mutation_analysis_report_corrected.txt', 'w') as f:
    f.write(output_text)

print("Full analysis report saved to: infinity_mutation_analysis_report_corrected.txt") 