...
module load vcf2maf/1.6.8
module load samtools/1.9
# module load vep/95

VCF_FILE="/bgfs/alee/LO_LAB/Personal/Daisong/CPT6/Mutect2/tumor_vs_liver_manual/tumor_vs_liver/tumor_vs_liver.vcf"
TUMOR_SAMPLE="B6ILC-cells"
NORMAL_SAMPLE="BL6-mouse-liver"
OUTPUT_MAF="/bgfs/alee/LO_LAB/Personal/Daisong/CPT6/maftools/tumor_vs_liver.maf"
REFERENCE_FASTA="/bgfs/alee/LO_LAB/Personal/Daisong/Reference_genome/Mouse/GRCm38.p4.genome/GRCm38.p4.genome.fasta"
VEP_PATH="/ihome/crc/install/vcf2maf/python2.7_1.6.8/bin/"
...
/ihome/crc/install/vcf2maf/python2.7_1.6.8/bin/perl -MBio::Perl -e 'print "BioPerl is now accessible\n"'

/ihome/crc/install/vcf2maf/python2.7_1.6.8/bin/perl /ihome/crc/install/vcf2maf/python2.7_1.6.8/bin/vcf2maf.pl \
    --input-vcf $VCF_FILE \
