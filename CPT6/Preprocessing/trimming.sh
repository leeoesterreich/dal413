...
designated_path="/bgfs/alee/LO_LAB/Personal/Daisong/CPT6/truseq"
...
# Input directories
input_dir1="/bgfs/alee/LO_LAB/Personal/Daisong/CPT6/00_fastq"
...
# Define adapter file
adapter_file="$designated_path/truseq_adapter.fa"
