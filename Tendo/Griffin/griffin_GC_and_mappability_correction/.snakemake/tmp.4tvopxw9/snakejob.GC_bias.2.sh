...
--wait-for-files /ix1/alee/LO_LAB/Personal/Daisong/Test_sample/Griffin/Griffin_updated/griffin_GC_and_mappability_correction/.snakemake/tmp.4tvopxw9 results/GC_counts/sample_name_1.GC_counts.txt --latency-wait 60 \
...
--mode 2  && touch /ix1/alee/LO_LAB/Personal/Daisong/Test_sample/Griffin/Griffin_updated/griffin_GC_and_mappability_correction/.snakemake/tmp.4tvopxw9/2.jobfinished || (touch /ix1/alee/LO_LAB/Personal/Daisong/Test_sample/Griffin/Griffin_updated/griffin_GC_and_mappability_correction/.snakemake/tmp.4tvopxw9/2.jobfailed; exit 1)
