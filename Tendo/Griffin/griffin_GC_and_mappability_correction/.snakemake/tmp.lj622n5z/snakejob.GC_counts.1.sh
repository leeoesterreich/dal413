...
--wait-for-files /ix1/alee/LO_LAB/Personal/Daisong/Test_sample/Griffin/Griffin_updated/griffin_GC_and_mappability_correction/.snakemake/tmp.lj622n5z /ix1/alee/LO_LAB/Personal/Daisong/Test_sample/5_mkdup/TP19-M480_FOL6151A5_S12rg.mkdp.bam --latency-wait 60 \
...
--mode 2  && touch /ix1/alee/LO_LAB/Personal/Daisong/Test_sample/Griffin/Griffin_updated/griffin_GC_and_mappability_correction/.snakemake/tmp.lj622n5z/1.jobfinished || (touch /ix1/alee/LO_LAB/Personal/Daisong/Test_sample/Griffin/Griffin_updated/griffin_GC_and_mappability_correction/.snakemake/tmp.lj622n5z/1.jobfailed; exit 1)
