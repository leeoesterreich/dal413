...
DRIVER_GENES = ['RAD17', 'RAD50', 'PALB2', 'TP53', 'BRCA1']
...
# Save results as CSV
res_df.to_csv('Basal_signaling_association_results.csv', index=False)
print('Results DataFrame saved as Basal_signaling_association_results.csv')
...
plt.ylabel('-log10(q)')
plt.title('Basal signaling signature association landscape (significant genes only)')
plt.legend()
plt.tight_layout()
plt.savefig('Basal_signaling_association_landscape.png', dpi=300)
print('Analysis complete. Plot saved as Basal_signaling_association_landscape.png') 