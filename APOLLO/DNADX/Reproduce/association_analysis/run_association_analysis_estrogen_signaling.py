...
plt.ylabel('-log10(q)')
plt.title('Estrogen signaling signature association landscape (significant genes only)')
plt.legend()
plt.tight_layout()
plt.savefig('Estrogen_signaling_association_landscape.png', dpi=300)
print('Analysis complete. Plot saved as Estrogen_signaling_association_landscape.png') 