...
DRIVER_GENES = ['HER1', 'HER2', 'HER4', 'EGFR', 'TGFA', 'AREG', 'EGF', 'KRAS', 'PIK3CA', 'AKT1', 'MEK1', 'ERK1']
SIGNATURE_NAME = 'UNC_HER1_Cluster2_Median_BMC.Genomics.2007_PMID.17663798'
GAIN_THRESHOLD = 0.3
LOSS_THRESHOLD = -0.3
QVAL_CUTOFF = 0.01
...
# Save results as CSV
res_df.to_csv('HER1-C2_association_results.csv', index=False)
print('Results DataFrame saved as HER1-C2_association_results.csv')
...
plt.ylabel('-log10(q)')
plt.title('HER1-C2 signature association landscape (significant genes only)')
plt.legend()
plt.tight_layout()
plt.savefig('HER1-C2_association_landscape.png', dpi=300)
print('Analysis complete. Plot saved as HER1-C2_association_landscape.png') 