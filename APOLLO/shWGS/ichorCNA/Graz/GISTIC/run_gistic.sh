...
# --- Configuration ---
# Define file paths
seg_file="/ix1/alee/LO_LAB/Personal/Daisong/Projects/APOLLO/shWGS/ichorCNA/Graz/GISTIC/all_IDC_segments.txt"
ref_gene_file="/ix1/alee/LO_LAB/Personal/Daisong/Projects/APOLLO/shWGS/ichorCNA/Graz/GISTIC/hg38.UCSC.add_miR.160920.refgene.mat"

# Create output directory
output_dir_base="GISTIC/gistic_run_NST"
