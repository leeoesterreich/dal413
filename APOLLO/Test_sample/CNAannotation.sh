...
# Input directory 
input_dir="/bgfs/alee/LO_LAB/Personal/Daisong/Test_sample/CNVkit/"
refFlatb38="/bgfs/alee/LO_LAB/Personal/Daisong/Test_sample/CNVkit/refFlat.txt"
cnvkit_dir="/bgfs/alee/LO_LAB/Personal/Daisong/Test_sample/CNVkit"
mkdir -p "$input_dir/temp_file"
temp_dir="$input_dir/temp_file"

# Output directory
output_dir="/bgfs/alee/LO_LAB/Personal/Daisong/Test_sample/CNVkit"
